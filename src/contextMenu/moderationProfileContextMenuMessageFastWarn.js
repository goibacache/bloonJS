 ...
 */
module.exports = {
	contextMenuId: 'moderationProfileFastWarn',
	data: new ContextMenuCommandBuilder()
		.setName('Message: Fast Warn')
	...
	async execute(interaction) {
		try{
			// Log for admin
			console.log(`Fast warn: '${this.data.name}' by ${interaction.member.user.tag} (${interaction.member.user.id})`);
