 ...
 */
module.exports = {
	contextMenuId: 'moderationReplyNewBloonMessageHere',
	data: new ContextMenuCommandBuilder()
		.setName('Message: New bloon message here')
	...
	async execute(interaction) {
		try{
			// Log for admin
			console.log(`New bloon message here: '${this.data.name}' by ${interaction.member.user.tag} (${interaction.member.user.id})`);
