	...
	async execute(interaction) {
		try{
			...
			await interaction.editReply( { content: `Hi! Glad to have you here, we always are looking for more people to join the league.\n
				There's two ways to join, ask a current team to join on their ranks or create your own. If you want to go te second route these are the requirements for your team:
