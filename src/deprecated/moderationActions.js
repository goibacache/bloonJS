...
//             const   moderationProfile       = await storedProcedures.moderationAction_Profile(target.id, interaction.guild.id);
...
//                     const caseID            = await storedProcedures.moderationAction_GetNewId(action, interaction.guild.id);
